const data = [
  ...
  },
  {
    image: "/tools/npm.svg",
    title: "NPM",
    description: "npm is the package manager for the Node JavaScript platform. It puts modules in place so that node can find them, and manages dependency conflicts intelligently.",
    learn: 2019,
  ...
  {
    image: "/tools/prettier.svg",
    title: "Prettier",
    description: "Prettier is an opinionated code formatter. It enforces a consistent style by parsing your code and re-printing it with its own rules",
    learn: 2022,
